...
const UpdateSliderPackage = () => {
    const { id } = useParams();
    const { data: singlePackageSlider = [], isLoading, isError, refetch, } = useQuery({
        queryKey: ["singleBanner"],
        queryFn: async () => {
            const res = await axiosPublic.get(`/package-slider/${id}`);
            return res.data;
        },
    });
    ...
    const handleSubmit = async (event) => {
        ...
        let ImageUrl = upcommigUrl;
        

        if(!image?.name){
            ImageUrl = upcommigUrl;
        }
        ...
        axiosPublic.put(`/package-slider/${id}`, data)
            .then(res => {
                if (res.data.insertedId) {
                    Swal.fire({
                        position: "top-end",
                        icon: "success",
                        title: "Packages Slider update successfully ",
    ...
    return (
        <div className="mx-auto mt-10 bg-white p-6 rounded-lg shadow-lg">
            <Helmet>
                <title>Dashboard | Update Package Slider</title>
            </Helmet>
            <h1 className="text-2xl font-bold text-gray-700 mb-6 text-center">
                Update Package Slider
            </h1>
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex flex-row gap-6">
                    ...
                    <div className="flex-1">
                        ...
                        <input
                            ...
                            defaultValue={singlePackageSlider?.title}
                    ...
                    <div className="flex-1">
                        ...
                        <input
                            ...
                            id="priceRange"
                            name="priceRange"
                            defaultValue={singlePackageSlider?.priceRange}
                ...
                <div>
                    ...
                    <textarea
                        ...
                        name="description"
                        rows="4"
                        defaultValue={singlePackageSlider?.description}
                        className="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 text-gray-700"
                    ></textarea>
                </div>
                ...
                <div className="avatar">
                    <div className="ring-primary ring-offset-base-100 w-24 rounded-full ring ring-offset-2">
                        <img src= { singlePackageSlider?.image }  />
                    </div>
                </div>
...
export default UpdateSliderPackage;
